...
int main () {
	...
	InsertFirst(&L1,Alokasi(7));InsertLast(&L1,Alokasi(4));InsertFirst(&L1,Alokasi(2));
	Printinfo(L1);
	InsertFirst(&L2,Alokasi(2));InsertLast(&L2,Alokasi(5));InsertFirst(&L2,Alokasi(3));
	Printinfo(L2);
	InsertFirst(&L3,Alokasi(2));InsertLast(&L3,Alokasi(3));InsertFirst(&L3,Alokasi(1));
	Printinfo(L3);
//	do {
//		Menu();
//		scanf("%d",&in);
...
//						scanf("%d",&optlist);
//						switch (optlist) {
//							case 1 	:	DelVAfter(&L1,&X,Alokasi(Xt));
//										break;
//							case 2 	:	DelVAfter(&L2,&X,Alokasi(Xt));
//										break;
//							case 3 	:	DelVAfter(&L3,&X,Alokasi(Xt));
//										break;
//							default : printf("Wrong Input\n");
//						}
//						printf("Elemen yang dihapus: %d\n", X);
