/* Program   : listgandadl.c */
/* Deskripsi : file REALISASI modul list ganda */
/* NIM/Nama  : 24060119130045/Nashirudin Baqiy */
/* Tanggal   : 26 November 2020 */
/***********************************/

#ifndef listgandadl_c
#define listgandadl_c
...
/* I.S.		: Sembarang, P sudah dialokasi
   F.S.		: P ditambahkan sebagai elemen terakhir yang baru */
    ...
    /* Algoritma */
    next(P) = Nil; //dicontoh docx pakai ini walau dialokasi sudah next(P) = Nil
	if (First(*L) == Nil){
		prev(P) = Nil;
		First(*L) = P;
		Last(*L) = P;
